...
| **[Pricing Table Seven](/docs/components/pricing-table/pricing-table-seven)**   | A clean and modern pricing plans UI with three tiered cards, a monthly/yearly toggle, and clear call-to-action buttons for different team sizes |
| **[Pricing Table Eight](/docs/components/pricing-table/pricing-table-eight)**   | Feature-comparison pricing table with aligned cards and user slider for comprehensive plan comparison |
...
| **[Payment Card Two](/docs/components/payment-card/payment-card-two/payment-card-two)** | Compact payment card with single card-number input and purchases preview |
